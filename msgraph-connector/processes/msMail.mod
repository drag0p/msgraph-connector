...
ml0 f0 inParamDecl '<msgraph.connector.NewMail mail> param;' #txt
...
' #txt
ml0 f0 callSignature writeMail(msgraph.connector.NewMail) #txt
ml0 f0 @CG|tags CONNECTOR #txt
...
>Proto ml0 .type msgraph.connector.MailData #txt
